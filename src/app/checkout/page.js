...
export default function Checkout() {
  ...
  const stripePromise =  loadStripe("pk_test_51JiZh8IQLcBHgvY5l871ihcQS17TuID3B8Q3RwimMroKEvw1szyOjlO4ygZRxZG0oVZSmBrEARL50OSEvl5rUtDX00w40dBvqA");
    ...
    <div>
      <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
        <div className="px-4 pt-8">
          <p className="font-medium text-xl text-gray-600">Cart Summary</p>
        ...
        <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
          <p className="text-xl font-medium text-gray-600 ">Shipping address details</p>
            ...
            {addresses && addresses.length ? (
              addresses.map((item) => (
                <div
                  ...
                  key={item._id}
                  className={`border p-6 text-gray-600 ${
